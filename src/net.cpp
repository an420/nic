...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "niccoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"niccointools.com", "dnsseed.niccointools.com"},
    {"niccoinpool.org", "dnsseed.niccoinpool.org"},
    {"xurious.com", "dnsseed.nic.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"niccointools.com", "testnet-seed.niccointools.com"},
    {"xurious.com", "testnet-seed.nic.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. niccoin is probably already running."), addrBind.ToString().c_str());
        else
